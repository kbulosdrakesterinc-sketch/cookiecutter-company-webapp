...
export default function RolesError({
  error,
  reset,
}: RolesErrorProps): React.ReactNode {
  return (
    <section
      aria-labelledby="roles-error-heading"
      className="rounded-xl border border-red-200 bg-red-50 p-6"
      role="alert"
    >
      <h1
        className="text-lg font-semibold text-red-950"
        id="roles-error-heading"
      >
        Roles directory unavailable
      </h1>

      <p className="mt-2 text-sm leading-6 text-red-800">
        The roles directory could not be loaded. Please try again.
      </p>
