...
export default function AuditLogError({
  error,
  reset,
}: AuditLogErrorProps): React.ReactNode {
  return (
    <section
      aria-labelledby="audit-log-error-heading"
      className="rounded-xl border border-red-200 bg-red-50 p-6"
      role="alert"
    >
      <h1
        className="text-lg font-semibold text-red-950"
        id="audit-log-error-heading"
      >
        Audit log unavailable
      </h1>
      <p className="mt-2 text-sm leading-6 text-red-800">
        The audit log could not be loaded. Please try again.
      </p>
