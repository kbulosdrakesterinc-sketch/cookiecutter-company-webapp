...
interface ReferenceDataErrorProps {
...
export default function ReferenceDataError({
  error,
  reset,
}: ReferenceDataErrorProps): React.ReactNode {
  return (
    <section
      aria-labelledby="reference-data-error-heading"
      className="rounded-xl border border-red-200 bg-red-50 p-6"
      role="alert"
    >
      <h1
        className="text-lg font-semibold text-red-950"
        id="reference-data-error-heading"
      >
        Reference data unavailable
      </h1>
      <p className="mt-2 text-sm leading-6 text-red-800">
        Reference data could not be loaded. Please try again.
      </p>
